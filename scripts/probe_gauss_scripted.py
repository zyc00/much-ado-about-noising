...
JOBS = [("scripted", SCR, [("MSE", "regression", "logs/full_regression_2000/models/model_latest.pt"),
                           ("MIP", "mip", "logs/full_mip_2000_s1/models/model_latest.pt"),
                           ("fadehint", "regression_fadehint", "logs/orig_fadehint/models/model_latest.pt"),
                           ("flow", "flow", "logs/flow_timeline/models/model_latest.pt"),
                           ("tjit01", "regression_tjitter", "logs/orig_tjit01/models/model_latest.pt")], 100),
        ]
