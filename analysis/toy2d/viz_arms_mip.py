...
ARMS = [("HG", "hg"), ("HT", "ht"), ("MIP 2-step", "mip")]
...
fig.suptitle("z-turn rollouts: HG / HT / MIP-2-step (30 traced rollouts each; "
             "red = scrape with final contact marked, grey = timeout)",
             fontsize=12.5)
fig.tight_layout(rect=[0, 0, 1, 0.94])
fig.savefig("arms_zturn_mip_hg_ht.png", dpi=160)
print("wrote arms_zturn_mip_hg_ht.png", flush=True)
