...
ARMS = [("L2", "l2"), ("HG", "hg"), ("HT", "ht"), ("flow32", "flow8")]
...
fig.suptitle("z-turn rollouts (canonical env): L2 / HG / HT / flow32 (30 traced rollouts each; "
             "red = scrape with final contact marked, grey = timeout)",
             fontsize=12.5)
fig.tight_layout(rect=[0, 0, 1, 0.94])
fig.savefig("arms_zturn_l2_hg_ht_flow.png", dpi=160)
print("wrote arms_zturn_l2_hg_ht_flow.png", flush=True)
