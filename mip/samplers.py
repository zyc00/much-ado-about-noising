...
def get_sampler(loss_type: str):
    ...
    elif loss_type in ["regression", "regression_relerr", "regression_fadehint", "regression_rw", "regression_cauchy", "regression_student_t", "regression_hetero_t", "regression_hetero_t_learnnu", "regression_hetero_t_learnnu_cond", "regression_hetero_t_learnnu_cond2", "regression_globalt", "regression_hgclip", "regression_gmm", "regression_sigmaw", "regression_selfsw", "regression_invw", "regression_gfloor", "regression_selfnorm", "regression_condreg", "regression_condreg_axis", "regression_condnum", "regression_pathdamp", "regression_focal", "regression_hetero_t_rankmid", "regression_hetero_t_jspec", "regression_jspec", "regression_hetero_t_mixnn", "regression_hetero_t_midlin", "regression_hetero_t_jitcons", "regression_hetero_gauss_midlin", "regression_hetero_gauss_jspec", "regression_hetero_gauss_rankmid", "regression_fdistill", "regression_condann", "regression_dcr", "regression_hetero_gauss_cnd", "regression_hetero_diag", "regression_hetero_t_diag", "regression_hetero_t_cnd", "regression_dcw", "regression_labelnoise", "regression_featdrop", "regression_snteach", "regression_emaret", "regression_hetero_gauss", "regression_sigaux", "regression_headonly", "regression_binw", "regression_distinc", "regression_hetero_t_fdlip", "regression_hetero_t_tublip", "regression_pace", "regression_paceabs", "regression_trim", "regression_normed", "regression_stdt", "regression_welsch", "regression_welsch_hetero", "regression_welsch_l2mix", "regression_barron", "regression_barron_hetero", "regression_barron_hetero_diag", "straight_flow", "regression_obsnoise", "regression_offmanjac", "regression_geomreg", "regression_stressreg", "regression_sigreg", "regression_randaug", "regression_tjitter", "regression_jacreg", "regression_dup100", "regression_frozentrunk", "regression_cvu", "regression_recgeo", "regression_pdprior", "regression_tauteacher", "regression_taufeat", "regression_badpen", "regression_opanchor"]:
    ...
    elif loss_type in ["tsd", "mip", "xm", "mip_cauchyv1", "mip_heterov1", "mip_rw", "mip_nonoise", "mip_nonoise_atk", "mip_shufx", "mip_shufx", "mip_auxtan", "mip_auxflip", "mip_auxdetach", "mip_distill", "mip_distill2", "mip_lambda", "mip_auxdet", "mip_zeroaux", "mip_tubeaux", "mip_scramaux", "mip_randaux"]:
        return mip_sampler
...
def xm_sampler(
    ...
    # pure XM inference: act_0 IS the latent draw (harness passes randn)
    bs = act_0.shape[0]
    t = torch.zeros(bs, device=act_0.device)
    obs_emb = encoder(obs, None)
    return flow_map.get_velocity(t, act_0, obs_emb)
